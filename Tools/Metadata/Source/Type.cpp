...
//CType::CManager::CManager()
//{
//#define STATIC_TYPE(A, B) static CType A##Type(#B, sizeof(B))
//    static CType Type("void");
...
//}
//
//CType::CManager& CType::Manager()
//{
//    static CType::CManager Mgr;
//    return Mgr;
//}
